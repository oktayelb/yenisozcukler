...
export function openModal(id) {
    ...
    if (id === 'aboutModal' || id === 'kvkkModal' || id === 'contactModal') document.body.style.overflow = 'hidden';
}
...
export function closeModal(id, force = false, e = null) {
    ...
    if (force || (e && e.target === m)) {
        ...
        if (id === 'aboutModal' || id === 'kvkkModal' || id === 'contactModal') document.body.style.overflow = '';
...
export const showKvkkInfo = () => openModal('kvkkModal');
export const closeKvkkInfo = (e, f) => closeModal('kvkkModal', f, e);
export const showContactInfo = () => openModal('contactModal');
export const closeContactInfo = (e, f) => closeModal('contactModal', f, e);
